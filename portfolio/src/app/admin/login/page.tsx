    ...
    <div className="min-h-screen bg-bg flex items-center justify-center">
      <div className="bg-surface border border-border rounded-lg p-8 w-full max-w-sm flex flex-col gap-4">
        ...
        <button onClick={handleGoogle} disabled={googleLoading}
          className="flex items-center justify-center gap-2 border border-border rounded px-4 py-2 text-sm text-text hover:border-accent hover:text-accent disabled:opacity-50 transition-colors">
